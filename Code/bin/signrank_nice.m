function [str, p, h, stats] = signrank_nice(x,y,varargin)
...
% JS 25 Nov 2025: changed first output into a string, like ttest_nice.
...
str = sprintf('Z=%.2f, p=%.4f (tail: %s), n1=%d, n2=%d',z,p,tail,length(x),length(y));
