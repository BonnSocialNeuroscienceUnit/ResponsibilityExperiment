function [result] = fit_happy_model_inequalitySimple(mtx,happyscore,constant)
...
result.paramNames = {'CR','EV','sRPE','gamma','inequality'};
if exist('constant','var') && ~isnan(constant)
