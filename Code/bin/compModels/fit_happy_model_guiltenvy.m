function [result] = fit_happy_model_guiltenvy(mtx,happyscore,constant)
...
result.paramNames = {'CR','EV','sRPE','gamma','guilt','envy'};
if exist('constant','var') && ~isnan(constant)
...
cert = data.certainmtx; ev = data.evmtx; rpe = data.rpemtx; 
dec = decayvec;
